                    ...
                    <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                        ...
                        <Grid item xs={12} md={6} >
                            ...
                            <Stack sx={{ width: '50%',  m: 1 }} >
                                ...
                                {errors.address?.type === 'minLength' && <Alert severity="warning"> {errors.address.message}</Alert>}
                            </Stack>
                            ...
                            <TextField 
                                    ...
                                    <Button variant='contained' type='submit' fullWidth className={classes.btn}>Confirm Now</Button>
