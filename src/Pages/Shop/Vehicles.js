...
const Vehicles = () => {
  ...
  useEffect(() => {
    fetch(
      `https://car-dealer-server-production.up.railway.app/vehicles?page=${page}&size=${size}&condition=${condition}&company=${company}&category=${category}`
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      `https://car-dealer-server-production.up.railway.app/vehicleCount?condition=${condition}&company=${company}&category=${category}`
    )
      .then((res) => res.json())
      .then((data) => {
