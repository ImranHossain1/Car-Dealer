            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Box paddingX={{xs:3 , sm:4, md:5, lg:10}} style={{display: 'flex', flexDirection:'column', color: 'gray', alignItems:'center', opacity:'1.0' }}>
                    ...
                    <Stack sx={{ width: '50%',  m: 1 }} >
                        {errors.vehicleModel?.type === 'required' && <Alert severity="warning" >{errors.vehicleModel.message}</Alert>}                    
                    </Stack>
                    ...
                    <Stack sx={{ width: '50%',  m: 1 }} >
                        {errors.cost?.type === 'required'  && <Alert severity="warning" >{errors.cost.message}</Alert>}                    
                    </Stack>
                    <TextField 
                        fullWidth
                        color="success"
